    ...
    <div>
      ...
      <div style={{ display: tryAgainView ? "none" : "flex" }} className="flex flex-col items-center h-screen w-screen">
        ...
        <div className="w-full sm:w-10/12 max-w-[576px] max-h-[40vh] relative ">
          ...
          <div ref={stoneRef} className=" scale-[0.85] sm:scale-100 transition-transform duration-1000 mt-64 sm:mt-32 mb-32 sm:mb-24 m-auto w-[95%] flex flex-col justify-center items-start rounded-t-full  bg-neutral-300 pt-10 sm:pt-20 px-4 pb-6 z-10">
